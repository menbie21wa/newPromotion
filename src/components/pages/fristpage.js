...
{/* Right Arrow */}
  <div className='hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-50%] right-0 text-2xl hover:border-2 py-2 md:py-12 lg:py-12 bg-white/20 hover:bg-black/20 border-black text-black cursor-pointer z-10'>
   <BsChevronCompactRight onClick={nextSlide} className='h-12 w-12' />
  </div>

        <div
          // style={{ backgroundImage: `url(${org && org[currentIndex]?.url})` }}
          className='w-full h-full bg-center duration-700 relative overflow-hidden bg-cover bg-no-repeat'
          >
